...
export const ExampleTableSearch = () => {
  return (
    <TableContainer>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          <TableCategory>Education</TableCategory>
          <TableCategory>
            <TableFlagContainer>
              <Image
          ...
          <TableCategory>
            310$ <ArrowStyled variant="up" />
          </TableCategory>
        </tr>
        <tr>
          <TableSubCategory>Books</TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory>
            80$ <ArrowStyled variant="down" />
          </TableSubCategory>
        </tr>
        <tr>
          <TableSubCategory>University</TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory>
            250$ <ArrowStyled variant="up" />
          </TableSubCategory>
        </tr>

        <tr>
          <TableCategory>
            Transport <ArrowStyled variant="expand" />
          </TableCategory>
          <TableCategory>
            <TableFlagContainer>
              <Image
        ...
        <tr>
          <TableSubCategory>Taxi</TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory></TableSubCategory>
          <TableSubCategory>
            250$ <ArrowStyled variant="up" />
